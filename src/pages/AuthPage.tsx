      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center p-12">
          <Link to="/" className="flex items-center gap-3 mb-12">
            <div className="w-14 h-14 rounded-xl gradient-primary flex items-center justify-center shadow-[0_0_30px_hsl(var(--primary)/0.5)]">
          ...
          <h1 className="font-display text-4xl font-bold mb-4">
            Xây dựng PC <span className="text-gradient-primary">hoàn hảo</span>
          </h1>
          <p className="text-lg text-muted-foreground max-w-md">
            Đăng nhập để lưu cấu hình, theo dõi đơn hàng và nhận gợi ý cá nhân hóa từ AI.
          </p>

          {/* Floating Elements */}
          <div className="absolute top-20 right-20 w-32 h-32 rounded-full bg-primary/10 blur-3xl animate-pulse-glow" />
          <div className="absolute bottom-20 right-40 w-40 h-40 rounded-full bg-accent/10 blur-3xl animate-pulse-glow" style={{ animationDelay: '1s' }} />
        </div>
      </div>
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="text-muted-foreground">
              {mode === 'login' 
                ...
                : 'Tạo tài khoản để bắt đầu build PC.'}
            </p>
          </div>
